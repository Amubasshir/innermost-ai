...
function FramerIcons(props) {
  ...
  return /* @__PURE__ */ _jsx("div", { "aria-hidden": "true", style: { display: "flex", maxWidth: "100%", maxHeight: "100%", alignItems: "center", justifyContent: "center", ...props.style }, dangerouslySetInnerHTML: { __html: customizedSvg } });
}
addPropertyControls(FramerIcons, { svg: { title: "SVG", type: ControlType.String, defaultValue: DEFAULT_SVG }, strokeWidth: { type: ControlType.Number, step: 0.25, min: 0.5, max: 2, defaultValue: DEFAULT_STROKE_WIDTH, hidden: (props) => hideStrokeWidth(props.svg) }, color: { type: ControlType.Color, defaultValue: DEFAULT_COLOR, description: "By [FramerIcons](https://www.framericons.com?utm=FramerIconComponent)" } });
